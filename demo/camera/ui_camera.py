...
class Ui_Camera(object):
    def setupUi(self, Camera):
        ...
        self.startPoseEstimationButton = QPushButton(self.centralwidget)
        self.startPoseEstimationButton.setObjectName(u"startPoseEstimationButton")

        self.gridLayout_3.addWidget(self.startPoseEstimationButton, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.metaDataButton, 6, 0, 1, 1)

        self.muteButton = QPushButton(self.tab)
        self.muteButton.setObjectName(u"muteButton")
        self.muteButton.setCheckable(True)

        self.gridLayout_2.addWidget(self.muteButton, 5, 0, 1, 1)
        ...
        self.matplotlibWidget = QWidget(self.previewPage)
        self.matplotlibWidget.setObjectName(u"matplotlibWidget")
        self.matplotlibWidget.setMinimumSize(QSize(434, 0))
        self.matplotlibWidget.setMaximumSize(QSize(434, 349))
        self.gridLayout_6 = QGridLayout(self.matplotlibWidget)
        self.gridLayout_6.setObjectName(u"gridLayout_6")
        self.lastImagePreviewLabel = QLabel(self.matplotlibWidget)
        ...
        self.gridLayout_6.addWidget(self.lastImagePreviewLabel, 0, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.matplotlibWidget, 1, 0, 1, 1)
    ...
    def retranslateUi(self, Camera):
        ...
        self.startPoseEstimationButton.setText(QCoreApplication.translate("Camera", u"Start Pose Estimation", None))
